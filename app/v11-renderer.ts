// @ts-nocheck
// The renderer is a direct source reconstruction of the v11 prototype markup.
const rooms = [
...
function profileAvatar() {
  return `<a class="profile-avatar" href="/account" aria-label="編輯帳戶資料" title="王小明的帳戶">王</a>`;
}

function top(title, back = "/") {
  if (!title) return `<header class="top"><div class="logo"><img class="brand-logo" src="data:image/png;base64," alt="南山人壽 NexSpace" width="291" height="56"></div><div style="flex:1"></div><a class="bell" href="/notifications" aria-label="通知中心">${icon("bell")}</a>${profileAvatar()}</header>`;
  return `<header class="top"><a class="back" href="${back}" aria-label="返回">${icon("chevron-left")}</a><div class="top-title">${title}</div><a class="bell" href="/notifications" aria-label="通知中心">${icon("bell")}</a>${profileAvatar()}</header>`;
}

function layout(path, title, body, back) {
  return `<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css"><style>${css}${accountCss}</style><div class="shell">${top(title, back)}${body}${nav(path)}</div>`;
}
...
function facilityHome(url) {
  ...
  return `<main class="page"><div class="lead"><h1>公共設施預約</h1><p>查詢公設時段、管理點數與預約</p></div><section class="credit"><span>可用點數</span><strong>${url.searchParams.get("topped")==="1"?265:165} 點</strong><div class="record-actions"><a class="btn secondary" href="/facility/history">使用記錄</a><a class="btn primary" href="/facility/topup">儲值點數</a></div></section>${fresh?`<div class="summary">✓ 公設預約已新增。</div>`:""}<div class="seg"><a class="on" href="/facility">我的預約</a><a href="/facility/query">預約查詢</a></div><article class="record"><div class="record-head"><div><h3>放映廳 3F-3</h3><p>#FAC-2026-0907</p></div><span class="status blue">已預約</span></div><p>08/06（四）16:00–17:00</p><div class="record-actions"><a class="btn secondary" href="/facility/edit">編輯</a><a class="btn danger" href="/facility/cancel">取消</a></div></article><article class="record"><div class="record-head"><div><h3>多功能室 3F-1</h3><p>#FAC-2026-0818</p></div><span class="status green">已結束</span></div><p>07/28（二）15:00–16:00</p><a class="btn secondary" href="/facility/detail">查看詳情</a></article></main>`;
}
...
function accountPage(url) {
  const saved = url.searchParams.get("saved") === "1";
  return `<main class="page">
    <div class="lead"><span class="eyebrow">MY ACCOUNT</span><h1>帳戶資料</h1><p>管理您的個人與工作聯絡資訊</p></div>
    ${saved ? `<div class="summary" style="margin-top:14px">${icon("circle-check")} 帳戶資料已更新</div>` : ""}
    <section class="account-hero"><div class="account-photo">王</div><div><h2>王小明</h2><p>wang.xiaoming@nexspace.com.tw</p><span class="account-role">${icon("building")} 租客員工</span></div></section>
    <section class="form-card">
      <form action="/account">
        <input type="hidden" name="saved" value="1">
        <label>姓名<input class="field" name="name" value="王小明" required></label>
        <label>手機號碼<input class="field" name="phone" inputmode="tel" value="0912-345-678" required></label>
        <label>Email<input class="field" name="email" type="email" value="wang.xiaoming@nexspace.com.tw" required></label>
        <label>所屬公司<input class="field" name="company" value="NexSpace 租戶企業" required></label>
        <label>使用部門<select class="field" name="department"><option>產品部</option><option>行銷部</option><option>總務部</option><option>財務部</option></select></label>
        <label>工作地點<select class="field" name="workspace"><option>NexSpace A 棟</option><option>NexSpace B 棟</option><option>NexSpace C 棟</option></select></label>
        <label class="checkbox"><input type="checkbox" checked> 接收預約與服務進度通知</label>
...
export function renderV11(pathname: string, search = "") {
    const url = new URL(pathname + search, "https://nexspace.local");
    ...
    else if (path === "/account") { title = "編輯帳戶"; body = accountPage(url); }
    ...
    return layout(path, title, body, back);
}
